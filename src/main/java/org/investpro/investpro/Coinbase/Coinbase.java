...
public abstract class Coinbase extends Exchange {
    ...
    public Coinbase(
            ...
            String apiSecret,
            String apiPass,
            ExchangeWebSocketClient webSocketClient) throws Exception {
        super(null);
    ...
    public static @NotNull Collection<? extends Order> getOrders() {
...
//       conn.setRequestProperty("Sec-Fetch-Mode", "cors");
    ...
    protected Coinbase(ExchangeWebSocketClient webSocketClient) {
        super(null);
        this.webSocketClient = webSocketClient;
    }
