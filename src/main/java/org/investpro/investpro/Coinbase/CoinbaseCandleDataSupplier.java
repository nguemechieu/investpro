 ...
 */
public abstract class CoinbaseCandleDataSupplier implements Supplier<Future<List<CandleData>>> {
    ...
    public CoinbaseCandleDataSupplier(int numCandles, int secondsPerCandle, String tradePair, IntegerProperty endTime) {
    ...
    public boolean equals(Object o) {
        ...
        CoinbaseCandleDataSupplier that = (CoinbaseCandleDataSupplier)  o;
