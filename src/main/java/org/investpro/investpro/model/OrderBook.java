...
public class OrderBook {
    ...
    public OrderBook(org.investpro.investpro.model.TradePair tradePair, double bidPrice, double askPrice, double bidLiquidity, double askLiquidity, Instant time) {
