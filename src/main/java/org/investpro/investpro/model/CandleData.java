...
public class CandleData {
    ...
    public CandleData(double openPrice, double closePrice, double highPrice, double lowPrice, double openTime, double volume) {
        this(openPrice, closePrice, highPrice, lowPrice, (int) openTime, volume, (highPrice + lowPrice) / 2,
