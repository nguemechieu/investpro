...
public class FiatCurrencyDataProvider extends CurrencyDataProvider {
    ...
    public static void registerCurrencies() {
        Currency.registerCurrencies(List.of(
                ...
                new FiatCurrency("Canadian dollar", "Canadian dollar", "CAD", 2, "$", Locale.of("en", "CA"),
                        "Bank of Canada", 124),
                new FiatCurrency("Swiss franc", "Franc", "CHF", 2, "Fr.", Locale.of("gsw", "CH"),
                        "Swiss National Bank", 756),
                new FiatCurrency("Chinese yuan", "Chinese yuan", "CNY", 2, "¥", Locale.of("zh", "CN"),
                        "People's Bank of China", 156),
                new FiatCurrency("Euro", "Euro", "EUR", 2, "€", Locale.of("fr", "FR"),
                        "European Central Bank", 978),
                new FiatCurrency("Pound sterling", "Pound", "GBP", 2, "£", Locale.of("en", "GB"),
                        "Bank of England", 826),
                ...
                new FiatCurrency("Japanese yen", "Yen", "JPY", 0, "¥", Locale.of("ja", "JP"),
                        "Bank of Japan", 392),
                new FiatCurrency("South Korean won", "Won", "KRW", 0, "₩", Locale.of("ko", "KR"),
                        "Bank of Korea", 410),
                ...
                new FiatCurrency("Swedish krona", "Krona", "SEK", 2, "kr", Locale.of("sv", "SE"),
                        "Sveriges Riksbank", 752),
                new FiatCurrency("Turkish lira", "Turkish lira", "TRY", 2, "₺", Locale.of("tr", "TR"),
                        "Central Bank of the Republic of Turkey", 949),
                new FiatCurrency("United States dollar", "U.S. dollar", "USD", 2, "$", Locale.of("en", "US"),
                        "Federal Reserve", 840),
