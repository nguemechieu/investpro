...
public class OandaContainer extends javafx.scene.layout.Region{
     ...
     */
        ...
        private final OandaCandleStickChartToolbar toolbar;
        ...
        public OandaContainer(Exchange exchange, String tradePair, boolean liveSyncing) throws URISyntaxException, IOException {
            ...
            toolbar = new OandaCandleStickChartToolbar(widthProperty(), heightProperty(),
