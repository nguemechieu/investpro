...
public class CandleStickChart extends Region {
     ...
     * be instantiated by a {@link OandaContainer}.
     *
    ...
    public CandleStickChart(Exchange exchange, CandleDataSupplier candleDataSupplier, String tradePair,
        ...
        ChangeListener<? super Boolean> gotFirstSizeChangeListener = new ChangeListener<>() {
            ...
            public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) {
                ...
                Callback<Order, javafx.beans.Observable[]> callback= param -> new Observable[0];
    ...
    private void CreateOrder(String side, double size, @NotNull PLATFORM exchangeName) throws OandaException {
        ...
        switch (exchangeName) {
            ...
            case COINBASE_PRO, OANDA -> Oanda.createMarketOrder(tradePair, "MARKET", side, (int) size);
    ...
    public Consumer<List<CandleData>> getCandlePageConsumer() {
