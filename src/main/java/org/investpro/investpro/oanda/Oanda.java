...
public class Oanda  extends Exchange {
    ...
    static String urls="";
    private static final ExchangeWebSocketClient da = new ExchangeWebSocketClient(
            URI.create(urls), new Draft_6455()) {
        @Override
    ...
    public Oanda(String s, String apiKey, String accountID) {
...
//
        ...
        req.header("Authorization", "Bearer " + Oanda.getApi_key());
