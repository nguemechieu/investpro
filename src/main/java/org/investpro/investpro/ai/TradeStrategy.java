...
public class TradeStrategy {
    ...
    private SIGNAL macdStrategy(List<CandleData> historicalPrices) {
        ...
        double signal = calculateEMA(historicalPrices.subList((int) (historicalPrices.getLast().getLowPrice() - 9), historicalPrices.size()), 9);
    ...
    private double calculateEMA(List<CandleData> prices, int period) {
    ...
    private SIGNAL bollingerBandStrategy(List<CandleData> historicalPrices, double close) {
