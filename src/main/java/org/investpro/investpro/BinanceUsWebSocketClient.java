...
public class BinanceUsWebSocketClient extends ExchangeWebSocketClient {
    ...
    public void onMessage(String message) {
        ...
        try {
            ...
            Log.error("Binance us websocket client: could not initialize trade pair: " +
    ...
    public void streamLiveTrades(@NotNull TradePair tradePair, LiveTradesConsumer liveTradesConsumer) {
        send(String.valueOf(OBJECT_MAPPER.createObjectNode().put("type", "subscribe")
                .put("id", String.valueOf(tradePair).replace("/", ""))));//.toString('-')).toPrettyString());
