...
public class StrategyAssignmentPanel extends VBox {
    ...
    private VBox createStrategyNotesSection() {
        ...
        strategyNotesArea.setPromptText("Add custom strategy notes, parameter details, or special conditions...");
    ...
    private void assignStrategy() {
        ...
        log.info(
                "Strategy Assigned: symbol={}, strategy={}, timeframe={}, confidence={}, signal={}, position={}, maxTrades={}, entry={}, exit={}, stopLoss={}, takeProfit={}, enabled={}, useRisk={}",
                symbol, strategy, timeframe, confidence, signalStrength, positionSize, maxTrades, entrySignal,
                exitSignal, stopLoss, takeProfit, enabled, useRisk);

        showInfo("Success", "Strategy assigned to " + symbol + " successfully!");
    }
