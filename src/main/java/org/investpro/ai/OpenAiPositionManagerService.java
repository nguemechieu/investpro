...
// * Fails safely to ESCALATE_TO_MANUAL_REVIEW if API is unavailable or response
// * is invalid.
// */
//@Slf4j
...
//            .getLogger(OpenAiPositionManagerService.class);
//
...
//                    ? json.get("suggestedStopLoss").getAsDouble()
//                    : null;
//            Double suggestedTakeProfit = json.has("suggestedTakeProfit")
//                    && !json.get("suggestedTakeProfit").isJsonNull() ? json.get("suggestedTakeProfit").getAsDouble()
//                            : null;
//            Double suggestedCloseQuantity = json.has("suggestedCloseQuantity")
//                    && !json.get("suggestedCloseQuantity").isJsonNull()
//                            ? json.get("suggestedCloseQuantity").getAsDouble()
//                            : null;
//            Double suggestedRiskReduction = json.has("suggestedRiskReductionPercent")
//                    && !json.get("suggestedRiskReductionPercent").isJsonNull()
//                            ? json.get("suggestedRiskReductionPercent").getAsDouble()
//                            : null;
//
