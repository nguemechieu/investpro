...
/**
 * Response object returned by AiPositionManagerService after reviewing an open position.
 * Contains AI recommendation, confidence, and detailed reasoning about the position.
 *
 * The AI NEVER modifies positions directly. This response feeds into PositionActionValidator
 * and PositionActionFinalGate for validation and final authority before execution.
 */
@Builder
@Getter
@Setter
