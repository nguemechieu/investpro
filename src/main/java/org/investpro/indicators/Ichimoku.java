 ...
 * Comprehensive indicator showing support, resistance, trend direction, and
 * momentum.
 */
public class Ichimoku extends BaseIndicator {

    private final int conversionPeriod;
    private final int basePeriod;
    private final int leadingSpanPeriod;

    public Ichimoku(int conversionPeriod, int basePeriod, int leadingSpanPeriod) {
