...
public class CorrelationRiskAnalyzer {
    ...
    public double analyzeCorrelationRisk(
        ...
        for (Position position : positions) {
            ...
            double positionExposurePercent = Math.abs(position.getQuantity() * position.getCurrentPrice() / context.getAccountEquity());
    ...
    private double calculateCorrelationBetweenTrades(
        ...
        return estimateCorrelationHeuristic(candidateSymbol, candidateAssetClass, candidateContractType, existingPosition);
    }
