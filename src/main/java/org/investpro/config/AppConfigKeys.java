...
public class AppConfigKeys {
    ...
    public static final String STRATEGY_ASSIGNMENT_PERSIST = "STRATEGY_ASSIGNMENT_PERSIST";
    public static final String STRATEGY_ASSIGNMENT_RECOVER_ON_STARTUP = "STRATEGY_ASSIGNMENT_RECOVER_ON_STARTUP";
    public static final String STRATEGY_ASSIGNMENT_AUTO_REASSIGN_ON_STARTUP = "STRATEGY_ASSIGNMENT_AUTO_REASSIGN_ON_STARTUP";
    public static final String STRATEGY_ASSIGNMENT_BLOCK_LIVE_ON_RECONCILIATION_FAILURE = "STRATEGY_ASSIGNMENT_BLOCK_LIVE_ON_RECONCILIATION_FAILURE";
    public static final String STRATEGY_ASSIGNMENT_REQUIRE_MANUAL_REVIEW_FOR_ORPHANED_POSITIONS = "STRATEGY_ASSIGNMENT_REQUIRE_MANUAL_REVIEW_FOR_ORPHANED_POSITIONS";
    public static final String STRATEGY_CHECKPOINT_ENABLED = "STRATEGY_CHECKPOINT_ENABLED";
    public static final String STRATEGY_CHECKPOINT_INTERVAL_SECONDS = "STRATEGY_CHECKPOINT_INTERVAL_SECONDS";
