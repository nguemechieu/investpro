...
import static org.investpro.PLATFORM.COINBASE_PRO;
import static org.investpro.oanda.OandaClient.*;
...
//Adding menu items
        ...
        menuElements.get(0).getItems().get(0).setOnAction(e -> {
            ...
            comboBox.setOnAction(selectEvent -> platform.setValue(comboBox.getValue().getValue()));
            StackPane pane0 = new StackPane(hbox, comboBox);

            scene = new Scene(pane0, 800, 600);
                ...
                event -> {//Open Market Buy Orders
                    try {
                        ...
                        if (amount > 0) {
                            ...
                            TradePair symbol9 = new TradePair(Currency.of(
    ...
    private void createLogin(@NotNull Stage stage) throws URISyntaxException {
        ...
        scene = new Scene(anchorPane, TRADING_SCREEN_WIDTH, TRADING_SCREEN_HEIGHT);
    ...
    private void createForgotPassword(@NotNull ActionEvent e) throws URISyntaxException {
        ...
        AnchorPane anchorPane = new AnchorPane(grid);
        scene = new Scene(anchorPane, 1530, 780);
        stage.setScene(scene);
...
Stage stage;    AnchorPane anchorpane = new AnchorPane();
    private void createMainScreen() throws Exception, OandaException {
        stage = new Stage();
         grid = new GridPane();
