...
@Slf4j
public class CoinbaseInstrumentService implements ExchangeInstrumentService {

    private static final String EXCHANGE_ID = "coinbase";
    private static final String ACCOUNT_ID = null;

    private final Exchange exchange;
    private final TradeablePairCache cache = TradeablePairCache.getInstance();

    public CoinbaseInstrumentService(Exchange exchange) {
