...
@Slf4j
public class OandaInstrumentService implements ExchangeInstrumentService {

    private static final String EXCHANGE_ID = "oanda";
    private static final String ACCOUNT_ID = null;

    private final Exchange exchange;
    private final TradeablePairCache cache = TradeablePairCache.getInstance();

    public OandaInstrumentService(Exchange exchange) {
