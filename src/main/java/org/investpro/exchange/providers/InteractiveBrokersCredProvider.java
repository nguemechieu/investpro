...
public class InteractiveBrokersCredProvider {
        ...
        public InteractiveBrokersCredProvider(CredentialProvider provider) {
            this.credentials = new ExchangeCredentialResolver(provider).resolve("ibk");
            logCredentialStatus();
        }
        ...
        public void logCredentialStatus() {
            log.info("IBK Credential Status:");
