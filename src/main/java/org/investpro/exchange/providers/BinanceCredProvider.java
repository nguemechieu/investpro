...
public class BinanceCredProvider {


        private ExchangeCredentials credentials;

        public BinanceCredProvider(CredentialProvider provider) {
            this.credentials = new ExchangeCredentialResolver(provider).resolve("binance");
            logCredentialStatus();
        }
        ...
        public void logCredentialStatus() {
            log.info("BINANCE  Credential Status:");
