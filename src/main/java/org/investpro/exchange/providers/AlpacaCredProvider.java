...
@Getter
@Setter
public class AlpacaCredProvider {

    private ExchangeCredentials credentials;

    public AlpacaCredProvider(CredentialProvider provider) {
        this.credentials = new ExchangeCredentialResolver(provider).resolve("Alpaca");
        logCredentialStatus();
    }
