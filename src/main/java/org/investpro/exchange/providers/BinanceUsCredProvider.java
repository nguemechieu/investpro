...
@Getter
@Setter
public class BinanceUsCredProvider {


        private ExchangeCredentials credentials;

        public BinanceUsCredProvider(CredentialProvider provider) {
            this.credentials = new ExchangeCredentialResolver(provider).resolve("binance us");
            logCredentialStatus();
        }
        ...
        public void logCredentialStatus() {
            log.info("BINANCE US Credential Status:");
